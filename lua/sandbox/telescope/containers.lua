...
return function()
  ...
  -- Asynchronous: `ps -a` is a real daemon round-trip and used to block the
  -- UI thread before the picker could even open. The adapter's optional
  -- on_done delivers the same values.
