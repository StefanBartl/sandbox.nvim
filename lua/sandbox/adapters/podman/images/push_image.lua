---@module 'sandbox.adapters.podman.images.push_image'
--- Podman Adapter: Push image to a remote registry
...
function M.push_image(name, on_done)
  return run_argv.run_async_captured({ "podman", "push", name }, function(ok, output)
