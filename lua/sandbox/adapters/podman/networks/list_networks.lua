---@module 'sandbox.adapters.podman.networks.list_networks'
--- Podman Adapter: Function to list all networks
...
function M.list_networks()
  local ok, output = run_argv.run_blocking_captured({ "podman", "network", "ls", "--format", "{{json .}}" })
