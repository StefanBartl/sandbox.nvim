---@module 'sandbox.adapters.podman.containers.rename_container'
--- Podman Adapter: Function to rename a container
...
function M.rename_container(container_id, new_name)
  local ok, output = run_argv.run_blocking_captured({ "podman", "rename", container_id, new_name })
