...
local remove_network = require("sandbox.adapters.nerdctl.networks.remove_network")
local inspect_network = require("sandbox.adapters.nerdctl.networks.inspect_network")
local connect_network = require("sandbox.adapters.nerdctl.networks.connect_network")
local prune_networks = require("sandbox.adapters.nerdctl.networks.prune_networks")

--- Network operations exposed by the Nerdctl adapter
return {
